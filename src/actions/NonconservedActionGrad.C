#include "NonconservedActionGrad.h"
...
registerMooseAction("felinoApp", NonconservedActionGrad, "add_variable");// ✅
registerMooseAction("felinoApp", NonconservedActionGrad, "add_kernel");// ✅

InputParameters
NonconservedActionGrad::validParams()
{
...
NonconservedActionGrad::NonconservedActionGrad(const InputParameters & params)
  : Action(params),
    _var_name(name()),
...
NonconservedActionGrad::act()
{
  ...
  else if (_current_task == "add_kernel")
  {
    ...
    bool use_grad_kappa = getParam<bool>("use_grad_kappa");// ✅// ✅
    if (use_grad_kappa)
