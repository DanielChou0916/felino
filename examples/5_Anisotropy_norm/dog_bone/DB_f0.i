# Adjustments 0719
# gc 10 -> 30
# alpha_critical 260 -> 520
# model AT2 -> AT1 
# f_alpha power 2 -> 0.5
# Normalization none -> det_norm
# status: fracture init at n = 5000
...
[Materials]
  ...
  [./fatigue_function]
    ...
    expression = 'if(bar_alpha > alpha_critical, (2*alpha_critical/(bar_alpha + alpha_critical))^p, 1)'
    constant_names       = 'p'
