 ...
 */
class PorousFlowFullySaturatedMassTimeDerivativeVariableBiot : public TimeKernel
{
public:
  static InputParameters validParams();

  PorousFlowFullySaturatedMassTimeDerivativeVariableBiot(const InputParameters & parameters);
...
protected:
  ...
  const MaterialProperty<Real> & _biot_coefficient;// ✅0402

  /// Constant Biot modulus
  const MaterialPropertyName _biot_modulus_name;// ✅0402
