 ...
 */
class PorousFlowPorosityVarBiot : public PorousFlowPorosityExponentialBase
{
public:
  static InputParameters validParams();

  PorousFlowPorosityVarBiot(const InputParameters & parameters);
...
protected:
  ...
  /// Biot coefficient
  const MaterialPropertyName _biot_coef_name;//✅
  ...
  MaterialProperty<Real> & _porosity_output;//✅
  const MaterialProperty<Real> * _porosity_ptr;//✅
};
